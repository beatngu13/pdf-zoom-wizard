...
/**
  'Set the color to use for nonstroking operations in device CMYK color space'
...
public final class SetDeviceCMYKFillColor
  extends SetFillColor
{
  ...
  {
    state.setFillColorSpace(DeviceCMYKColorSpace.Default);
    super.scan(state);
  }
  // </public>
  // </interface>
