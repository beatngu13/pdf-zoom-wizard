...
/**
  'Set the color to use for stroking operations in device RGB color space'
...
public final class SetDeviceRGBStrokeColor
  extends SetStrokeColor
{
  // <class>
  // <static>
  // <fields>
  public static final String Operator = "RG";
  // </fields>
  // </static>
  ...
  {
    state.setStrokeColorSpace(DeviceRGBColorSpace.Default);
    super.scan(state);
  }
  // </public>
  // </interface>
