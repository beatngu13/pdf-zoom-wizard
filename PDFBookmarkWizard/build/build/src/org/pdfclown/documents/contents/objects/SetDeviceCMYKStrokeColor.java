...
/**
  'Set the color to use for stroking operations in device CMYK color space'
...
public final class SetDeviceCMYKStrokeColor
  extends SetStrokeColor
{
  ...
  {
    state.setStrokeColorSpace(DeviceCMYKColorSpace.Default);
    super.scan(state);
  }
  // </public>
  // </interface>
